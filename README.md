...
| 구분 | 내용 |
|------|------|
| 희망 기간 | 2026년 1월 21일 ~ 2026년 5월 1일 (102일) |
| 신청 이유 | 어린이집 적응 기간(3월 한 달) 및 4월까지 추가 케어가 필요하여 신청 |
| 회사 업무 | - 어린이집 등원 전: 재택근무 형태로 지원 가능 (집중 업무시간 설정 예정)<br>- 어린이집 등원 후: 주차별로 등원 시간 증가에 따라 업무 시간 점진적 확대 |
| 참고 사항 | 육아 휴직 30일 이전에 신청이 필요하다고함(시작 7일 전까지 취소가능), 면접결과에 따라 취소/변경 및 재신청할 예정|
...
| 6월 | 단축근무 | 9:00 | 2시간 | 16:00 | 연장반을 신청하여 늦게 하원 |
